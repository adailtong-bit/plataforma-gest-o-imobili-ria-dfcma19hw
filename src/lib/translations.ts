...
export const translations = {
  ...
  es: {
    ...
    marketing: {
      ...
      automated_desc: 'Disparar correos basados en eventos.',
    ...
    reports: {
      ...
      subtitle:
        'Análisis de inventario, mantenimiento y condiciones de propiedad.',
      period: 'Período',
      property: 'Propiedad',
      apply_filters: 'Aplicar Filtros',
    ...
    calendar: {
      ...
      no_activities: 'No hay actividades programadas para hoy.',
    },
    messages: {
      title: 'Mensajes',
    ...
    common: {
      ...
      delete_linked_error:
        'No se puede eliminar porque hay registros vinculados.',
    },
    marketing_tab: {
    ...
    automation: {
      ...
      auto_approval_desc:
        'Aprovar automáticamente tareas de mantenimiento por debajo de un costo determinado.',
      ...
      tasks_below_threshold:
        'Las tareas por debajo de este monto se aprobarán instantáneamente.',
      trigger_event: 'Evento Desencadenante',
      ...
      choose_data_range:
        'Elija el rango de datos para la exportación de QuickBooks.',
