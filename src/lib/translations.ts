...
export const translations = {
  ...
  // English and Spanish keys would be maintained similar to 'pt' but in their respective languages.
  // For brevity in this answer, I am only filling 'pt' as per request details,
  // but in a real app, 'en' and 'es' must mirror 'pt' structure.
