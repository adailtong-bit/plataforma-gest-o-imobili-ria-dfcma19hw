    ...
    Tables: {
      ...
      hotels: {
        Row: {
          ...
          created_at: string
          gallery: string[] | null
          game_room_access_code: string | null
          general_access_code: string | null
          id: string
          image: string | null
      ...
      visits: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'visits_task_id_fkey'
            columns: ['task_id']
            isOneToOne: false
...
//   payment_data: jsonb (nullable, default: '{}'::jsonb)
//   gallery: _text (nullable, default: '{}'::text[])
//   billing_phone: text (nullable)
//   general_access_code: text (nullable)
//   pool_access_code: text (nullable)
//   game_room_access_code: text (nullable)
...
//   visitor_document: text (nullable)
//   visit_date: timestamp with time zone (not null)
//   purpose: text (not null, default: 'showing'::text)
...
// Table: ledger_entries
//   FOREIGN KEY ledger_entries_booking_id_fkey: FOREIGN KEY (booking_id) REFERENCES bookings(id) ON DELETE SET NULL
...
// Table: visits
//   PRIMARY KEY visits_pkey: PRIMARY KEY (id)
//   FOREIGN KEY visits_property_id_fkey: FOREIGN KEY (property_id) REFERENCES properties(id) ON DELETE CASCADE
//   FOREIGN KEY visits_task_id_fkey: FOREIGN KEY (task_id) REFERENCES tasks(id) ON DELETE SET NULL
...
//     WITH CHECK: true
// Table: condominiums
//   Policy "condominiums_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: conversation_participants
...
//     USING: is_admin_or_pm()
//     WITH CHECK: is_admin_or_pm()
//   Policy "authenticated_select_invoices" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
...
//     USING: is_admin_or_pm()
//     WITH CHECK: is_admin_or_pm()
//   Policy "authenticated_select_ledger" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
...
//     USING: true
//   Policy "properties_delete_auth" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "properties_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: true
//   Policy "properties_insert_auth" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: true
//   Policy "properties_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "properties_select_all" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "properties_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
//   Policy "properties_update_auth" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: publicity_campaigns
...
//     USING: true
// Table: visits
//   Policy "visits_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
...
// Table: visits
//   trg_sync_visit_to_task: CREATE TRIGGER trg_sync_visit_to_task BEFORE INSERT OR UPDATE ON public.visits FOR EACH ROW EXECUTE FUNCTION sync_visit_to_task()
//   trg_sync_visit_to_task_delete: CREATE TRIGGER trg_sync_visit_to_task_delete AFTER DELETE ON public.visits FOR EACH ROW EXECUTE FUNCTION sync_visit_to_task()
