...
export function TaskDetailsSheet({
  ...
  const { approveTask } = useTaskStore()
                            ...
                            <>
                              <div className="col-span-2 md:col-span-1">
                                <span className="text-muted-foreground text-xs block flex items-center gap-1">
                                  <Hammer className="h-3 w-3" /> Custo Mão de
                                  Obra
                                </span>
                              ...
                              {task.materialCost && task.materialCost > 0 && (
                                <div className="col-span-2 md:col-span-1">
                                  <span className="text-muted-foreground text-xs block flex items-center gap-1">
                                    <HardHat className="h-3 w-3" /> Custo
                                    Material
                                  </span>
                                  <span className="font-medium text-gray-700">
                                    <DataMask>
                    ...
                    task.history
                      ...
                      .map((item, idx) => (
                        <div key={idx} className="relative pl-6 pb-2">
                          <div
                            className={`absolute -left-[5px] top-1 h-2.5 w-2.5 rounded-full border border-white ${
                              item.action === 'approve'
                                ? 'bg-green-500'
                                : item.action === 'reject'
                                  ? 'bg-red-500'
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            {item.note && (
                              <div className="mt-1 p-2 bg-muted/40 rounded-md text-xs italic text-slate-700 border">
